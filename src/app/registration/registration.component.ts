...
export class RegistrationComponent implements OnInit {
  ...
  constructor() {
    ...
    this.registrations.push(new Registration('Deepak', 'Sharma', {
      year: 1987,
      month: 8,
      day: 13
    }, 'xyz@gmail.com', 'password', 'UK'));
    this.registrations.push(new Registration('Rohit', 'Sahu', {
      year: 1975,
      month: 12,
      day: 3
    }, 'rohit1234@gmail.com', 'password', 'UAE'));
    this.registrations.push(new Registration('Akash', 'Kumar', {
      year: 1989,
      month: 7,
      day: 25
    }, 'akash1234@gmail.com', 'password', 'India'));
  }
  ngOnInit() {
  }
